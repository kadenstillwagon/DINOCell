...
def run_pca_visualization_DINOCell(model, patch_size, fig_name):
    ...
    img = Image.open('../../DINO_Dataset_1024/train/pc_bf/Cellpainting_Gallery_cpg0024_cpg0024-bortezomib_source_4_images_2021_08_23_Batch12_images_BR00126734__2021-09-08T09_18_47-Measurement2_Imagesr03c13f02p01-ch6sk1fk1fl1.tiff').convert('RGB')
